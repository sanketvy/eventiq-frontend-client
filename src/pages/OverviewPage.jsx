...
const OverviewPage = ({selectedProject, selectedTimeRange, refresh}) => {
    ...
    useEffect(() => {
        axios.post(AnalyticsService.dashboard, {
            ...
            setMetrics(res.data);
            setSessionData(res.data.sessionsData);
        })
    }, [refresh, selectedProject, selectedTimeRange]);
            ...
            <div className="space-y-6 p-2">
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div
                            className={`w-3 h-3 rounded-full ${realTimeEnabled ? 'bg-green-400 animate-pulse' : 'bg-slate-500'}`}/>
                    </div>
                </div>
                                    ...
                                    <div key={event.type} className="p-4 bg-slate-700/30 rounded-lg">
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <div className={`flex items-center space-x-1 text-xs ${
                                                ...
                                                {event.change >= 0 ? <TrendingUp className="w-3 h-3"/> :
